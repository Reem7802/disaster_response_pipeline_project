...
def load_data(messages_filepath, categories_filepath):
    ...
    '''
    This function load data from messages and categories files
...
def clean_data(df):
    ...
    '''
    This function convert category values to just numbers 0 or 1, Remove duplicates and clean categories
